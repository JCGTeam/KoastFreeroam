...
function Pong:Render( args )
	if active then
		...
		ExtRender:DrawShadowedText( pong_draw_start + Vector2( 0, pong_table_height + 5 ), self.you_txt .. scores[1], Color( 255, 255, 255 ), Color( 25, 25, 25, 150 ) )
		ExtRender:DrawShadowedText( pong_draw_start + Vector2( pong_table_width - 65, pong_table_height + 5 ), self.enemy_txt .. scores[2], Color( 255, 255, 255 ), Color( 25, 25, 25, 150 ) )
		ExtRender:DrawShadowedText( pong_draw_start + Vector2( pong_table_width / 2 - Render:GetTextWidth( self.limit_txt ) / 2, pong_table_height + 5 ), self.limit_txt .. score_limit, Color( 255, 255, 255 ), Color( 25, 25, 25, 150 ) )

		ExtRender:DrawShadowedText( pong_draw_start + Vector2( pong_table_width / 2 - Render:GetTextWidth( self.tip_txt, 18 ) / 2, pong_table_height + 50 ), self.tip_txt, Color( 255, 255, 255 ), Color( 25, 25, 25, 150 ), 18 )
