...
function Admin:spectateRender()
	...
	if self.victim and self.spVictimPos and self.spVictimAng and IsValid( self.victim, false ) then
		...
		ExtRender:DrawShadowedText( Vector2( Render.Size.x / 2 - Render:GetTextWidth( info_txt, 20 ) / 2, Render.Size.y - 65 ), info_txt, Color.White, Color.Black, 20 )
	else
		ExtRender:DrawShadowedText( Vector2( Render.Size.x / 2 - Render:GetTextWidth( spectate_txt .. "Х/З", 20 ) / 2, Render.Size.y - 65 ), spectate_txt .. "Х/З", Color.White, Color.Black, 20 )
	end
end
...
function Admin:renderShout()
	ExtRender:DrawShadowedText( Vector2( Render.Width / 2 - ( Render:GetTextWidth( self.shoutName, 30 ) / 2 ), self.sy / 1.8 ), self.shoutName, Color( 255, 200, 0 ), Color( 0, 0, 0, 150 ), 30 )
	ExtRender:DrawShadowedText( Vector2( Render.Width / 2 - ( Render:GetTextWidth( self.shoutMessage, 30 ) / 2 ), self.sy / 1.8 + 50 ), self.shoutMessage, Color( 255, 200, 0 ), Color( 0, 0, 0, 150 ), 30 )
end
