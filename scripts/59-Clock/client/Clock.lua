...
function Clock:Render()
	...
	ExtRender:DrawShadowedText( position, textTime, Color( 255, 255, 255, Game:GetSetting(4) * 2.25 ), Color( 25, 25, 25, Game:GetSetting(4) * 2.25 ), 24 )

	local height = Render:GetTextHeight("A") * 1.5
	position.y = position.y + height
	ExtRender:DrawShadowedText( position, textDate, Color( 255, 165, 0, Game:GetSetting(4) * 2.25 ), Color( 25, 25, 25, Game:GetSetting(4) * 2.25 ), 16 )		
end
